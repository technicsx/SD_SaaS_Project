REL_ALARMS_DATA_FILE = "external_data/alarms/alarms.csv"
REL_REGIONS_DATA_FILE = "external_data/additions/regions.csv"
REL_ISW_TF_IDF_RESULT = "2_data_preparation/results/tfidf.csv"
